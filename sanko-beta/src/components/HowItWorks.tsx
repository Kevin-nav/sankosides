    ...
    return (
        ...
        >
            <div className="container max-w-5xl mx-auto">
                ...
                <div className="hidden sm:block absolute left-1/2 -translate-x-1/2 top-1/2 w-2/3 h-px bg-gradient-to-r from-transparent via-emerald-500/30 to-transparent" />
