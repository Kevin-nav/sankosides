...
export function Hero({ onCtaClick }: HeroProps) {
    ...
    return (
        <section
            ref={heroRef}
            className="min-h-screen flex flex-col justify-center px-4 pt-20 pb-12 sm:px-6 lg:px-8"
        >
            <div className="container text-center max-w-5xl mx-auto">
                ...
                <button
                    ref={ctaRef}
                    onClick={onCtaClick}
                    className="btn btn-primary btn-lg group tap-feedback px-10 py-4"
                    style={{ opacity: 0 }}
                >
                ...
                <div
                    ...
                    style={{ opacity: 0 }}
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-20 relative items-stretch">
                        {/* Before Card */}
                        <div className="glass-card p-6 sm:p-8 text-left hover-lift tap-feedback h-full flex flex-col border border-white/5 rounded-3xl">
                        ...
                        {/* After Card */}
                        <div className="glass-card-elevated p-6 sm:p-8 text-left hover-lift tap-feedback animate-glow-pulse relative overflow-hidden h-full flex flex-col rounded-3xl border border-emerald-500/20">
                            ...
                            <div className="relative flex-grow flex flex-col h-full z-10">
                                ...
                                {/* Floating Badge */}
                                <div className="absolute bottom-4 right-4 translate-y-2 translate-x-2">
                                    <span className="verified-badge text-xs shadow-lg bg-emerald-950/80 backdrop-blur-md border-emerald-500/40 text-emerald-300">
                    ...
                    <div className="hidden md:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                        <div className="w-14 h-14 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 flex items-center justify-center shadow-xl shadow-emerald-500/40 animate-float border-4 border-neutral-950">
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Students from UMaT have already joined</span>
                    </div>
